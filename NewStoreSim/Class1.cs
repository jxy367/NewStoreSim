...
namespace NewStoreSim
{
    class Sim
    {
        ...
        //Constructor
        public Sim( double sd_customers, int avg_items, int sd_items, int avg_time, int sd_time, double avg_processing_time, double sd_processing_time, int num_registers, int milliseconds_per_refresh, int max_time)
        {
